...
<table cellpadding="0" cellspacing="0" border="0" id="vote"> 
    ...
    <%Results r=null;
        ...
        try {
            String query="select party,name,value,district from tblcandidate Order By district ";

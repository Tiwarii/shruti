...
<body onload="notify_date()">
            ...
            <ul class="nav nav-tabs">
                ...
                %>
                 ...
                 <div id="reg">  <li ><a href="registrationForm.jsp"><span class="glyphicon glyphicon-earphone"></span>&nbsp;Registration</a></li></div>
          ...
          <div id="result">    <li ><a href="define?page=map"><span class="glyphicon glyphicon-hand-up"></span>&nbsp;Result</a></li></div>
